...
import { BatteryCharging, Sun, Lightning, ArrowRight, Clock, ShieldCheck } from '@phosphor-icons/react';
    ...
    <div className="card" style={{ flex: 1 }}>
      <div className="card-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <BatteryCharging size={16} weight="duotone" color="#00e676" />
      ...
      <div className="battery-flow-grid">
        <div>
                    <Sun size={14} weight="duotone" color="#ffb703" style={{ margin: '0 auto 3px' }} />
        ...
        <div className="energy-flow-arrow">
                    <ArrowRight size={16} weight="bold" color={potSaldo >= 0 ? '#00e676' : '#ff1744'} />
        </div>
        <div>
                    <Lightning size={14} weight="duotone" color="#00f2fe" style={{ margin: '0 auto 3px' }} />
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 8, paddingTop: 6, borderTop: '1px solid rgba(255,255,255,0.06)', fontSize: 10, fontFamily: 'var(--font-mono)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 4, color: 'var(--text-dim)' }}>
                    <Clock size={12} weight="duotone" color="#00f2fe" />
          Autonomia: <strong style={{ color: 'var(--text-main)' }}>{estimativaHoras}</strong>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    <ShieldCheck size={12} weight="duotone" color="#00e676" />

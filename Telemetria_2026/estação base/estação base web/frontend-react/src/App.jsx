...
import { fetchSessaoAtiva, fetchHistoricoSessao } from './services/api';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    return () => { socket.off('connect'); socket.off('disconnect'); socket.off('sessao_ativa'); socket.off('sessao_alterada'); socket.off('serial_status'); socket.off('telemetria_data'); };
  }, []);
